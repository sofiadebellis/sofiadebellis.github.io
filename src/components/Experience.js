...
const workExperience = [
  {
    ...
    term: "Atlassian (Feb 2025 - Current)",
  },
  {
    company: unsw,
    role: "Casual Academic and Course Admin",
    term: "UNSW Sydney (May 2022 - Current)",
  },
  {
    company: canva,
    role: "Frontend Software Engineering Intern",
    term: "Canva (Nov 2024 - Feb 2025)",
  },
  {
    company: atlassian,
    role: "Fullstack Software Engineering Intern",
    term: "Atlassian (Sep 2023 - Jan 2024)",
  },
  {
    company: optiver,
    role: "Future Focus program",
    term: "Optiver (Sep 2022)",
  },
  {
    company: rev,
    role: "Fullstack Software Engineering Intern",
    term: "Revolutionise Sport (Nov 2022 - Feb 2023)",
  },
  {
    company: unsw,
    role: "Student Ambassador",
    term: "UNSW Sydney (May 2022 - Dec 2024)",
  },
  {
    company: codecamp,
    role: "Head Teacher",
    term: "Code Camp (Aug 2019 - Sep 2023)",
  },
  {
    company: connectedcode,
    role: "Tutor",
    term: "ConnectEd Code (Mar 2022 - Current)",
  },
];
            ...
            <Stack spacing={3}>
              {workExperience.map((item) => (
                <StyledListItem>
                  ...
                  <ListItemText primary={item.role} secondary={item.term} />
                </StyledListItem>
              ))}
            </Stack>
          </List>
